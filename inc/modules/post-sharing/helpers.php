 ...
 */
function ress_update_count( $current, $new ) {
 ...
 */
function ress_update_count_total( $total, $new ) {
 ...
 */
function ress_post_sharing_services_admin( $type = 'selected' ) {

    $services = ress_post_sharing_filter_services( $type );
 ...
 */
function ress_post_sharing_count_display( $count, $thousand = 'K', $million = 'M' ) {
    ...
    return apply_filters('ress_post_sharing_count_display', absint( $result ), $count);
 ...
 */
function ress_post_sharing_prepare_count_totals( $results ) {
 ...
 */
function ress_post_sharing_display_counts( $count, $option ) {
 ...
 */
function ress_get_max_site_width() {
     ...
     */
    return apply_filters( 'ress_max_site_width', $max_site_width );
